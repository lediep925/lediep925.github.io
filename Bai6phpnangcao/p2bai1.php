...
$ket_qua = 0;
$mang_so = 0;
$nhap_mang_value = ''; // Initialize $nhap_mang_value to an empty string

if(isset($_POST['btn_goi'])){
    // Check if $_POST['nhap_mang'] is set before using it
    $nhap_mang_value = isset($_POST['nhap_mang']) ? $_POST['nhap_mang'] : '';
