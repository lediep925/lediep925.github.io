...
?>
<form action="bai4p2xuly.php" method="post">
...
<td width="175"><label for="textfield1"></label>
<input type="text" name="so_cuoi" id="textfield1" value="<?php if(isset($_POST["so_cuoi"]))
	echo $_POST["so_cuoi"];?>"/></td>
</tr>
<tr>
...
<td colspan="4"><label for="textfield7"></lable>
